...
func _ready():
	...
	primary_shot_debounce_time = 60.0 / 50.0 / 60.0#0.125 #1.0 / 60.0# 60 times per second  #0.01666666666666666666666666666667
	...
	gun_name = "SomeRapidFireGunForRenaming"
	shop_description = "Destroy everything with shots " + str(shots_per_second) + " times per second!"
